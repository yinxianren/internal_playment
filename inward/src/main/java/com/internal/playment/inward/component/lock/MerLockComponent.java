...
//        );
//        if(isNull(merchantInfoTable)) throw new Exception(format("商户号：%s,此时商号不存在！",merId));
//        Object object = concurrentHashMap.get(merchantInfoTable.getMerchantId());
//        if(isNull(object)){
//            object = new Object();
//            concurrentHashMap.put(merchantInfoTable.getMerchantId(),object);
//        }
//        return object;
//    }
//
